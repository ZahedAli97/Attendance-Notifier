...
def main(name,email,attendance):
    # print(attendance)
    to = email
    sender = "zahedmiralirh@gmail.com"
    subject = "Hi, This is from Python. Regarding your Attendance"
    msgHtml = "Hi "+name+"<br/>Your Attendance is only "+str(attendance)+"%."
    msgPlain = "Hi\nPlain Email"
...
if __name__ == '__main__':
    ...
    schedule.every(1).minutes.do(cs)
    # schedule.every().monday.do(cs)
